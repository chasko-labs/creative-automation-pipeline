...
| `scripts/sync-asset-store.sh`, `scripts/seed-kodiak-s3.sh`, `scripts/diagnose.sh`                 | team-platform             | dam + ops scripts                                                                                                                    |
| `docs/asset-library-runbook.md`, `docs/nova-act-runbook.md`                                         | team-platform             | ops runbooks                                                                                                                         |
