...
| ------------------------------------------------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| local `run_pipeline()` end to end                             | live                  | compose/localize/render/compliance; hero via Nova Pro on real assets, falling back to the flagship brand hero so every product returns a real composite                                                                            |
