...
4. local browser testing: run the repository-owned Playwright and pixel checks for preview.html at 3 viewports, then retain the structured evidence locally
