import{a as e}from"./chunk-chunk-G6O6BLNK.js";var t="prePassDeclaration",x=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=x);var o="oitDeclaration",C=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=C);var i="lightFragmentDeclaration",L=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=L);var a="lightUboDeclaration",E=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=E);var r="samplerFragmentDeclaration",T=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=T);var n="imageProcessingDeclaration",X=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=X);var s="imageProcessingFunctions",I=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=I);var l="shadowsFragmentFunctions",A=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=A);var d="bumpFragmentMainFunctions",P=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=P);var f="bumpFragmentFunctions",F=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=F);var c="reflectionFunction",M=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=M);var h="decalFragment",y=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=y);var v="bumpFragment",N=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=N);var u="depthPrePass",O=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=O);var p="lightFragment",R=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=R);var m="logDepthFragment",b=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=b);var S="oitFragment",U=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=z);var D="clusteredLightingFunctions",H=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
