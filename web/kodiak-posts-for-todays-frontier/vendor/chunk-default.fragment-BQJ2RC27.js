import"./chunk-chunk-F7EYQN7P.js";import"./chunk-chunk-L6MH7M3Y.js";import"./chunk-chunk-RJVZMLNZ.js";import{a as e}from"./chunk-chunk-G6O6BLNK.js";var t="decalFragmentDeclaration",w=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=w);var o="defaultFragmentDeclaration",x=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=x);var r="prePassDeclaration",P=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=P);var a="oitDeclaration",X=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=X);var n="lightFragmentDeclaration",F=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=F);var l="lightUboDeclaration",R=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=N);var f="clusteredLightingFunctions",M=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=M);var d="lightsFragmentFunctions",O=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=O);var c="shadowsFragmentFunctions",_=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=_);var h="samplerFragmentDeclaration",y=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=y);var v="fresnelFunction",b=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=b);var u="reflectionFunction",U=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=U);var p="imageProcessingDeclaration",W=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=W);var m="imageProcessingFunctions",H=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=H);var g="bumpFragmentMainFunctions",z=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=z);var S="bumpFragmentFunctions",V=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=V);var E="bumpFragment",G=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=G);var C="decalFragment",B=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=B);var D="depthPrePass",k=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=k);var L="lightFragment",Y=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Y);var T="logDepthFragment",Z=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=Z);var I="oitFragment",q=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=q);var i="defaultPixelShader",A=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=A);var Ci={name:i,shader:A};export{Ci as defaultPixelShader};
