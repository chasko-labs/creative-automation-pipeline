...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=f);var r="lightsFragmentFunctions",l=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=l);var t="fresnelFunction",a=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=a);var i="defaultPixelShader",n=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=n);var j={name:i,shader:n};export{j as defaultPixelShader};
