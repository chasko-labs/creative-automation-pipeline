import{a as e}from"./chunk-chunk-G6O6BLNK.js";var o="sceneUboDeclaration",n=`layout(std140,column_major) uniform;uniform Scene {mat4 viewProjection;
#ifdef MULTIVIEW
mat4 viewProjectionR;
#endif 
mat4 view;mat4 projection;vec4 vEyePosition;mat4 inverseProjection;};
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=n);var t="meshUboDeclaration",c=`#ifdef WEBGL2
...
#endif
#define WORLD_UBO
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=c);var i="defaultUboDeclaration",s=`layout(std140,column_major) uniform;uniform Material
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=s);var r="mainUVVaryingDeclaration",f=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=f);var a="logDepthDeclaration",l=`#ifdef LOGARITHMICDEPTH
