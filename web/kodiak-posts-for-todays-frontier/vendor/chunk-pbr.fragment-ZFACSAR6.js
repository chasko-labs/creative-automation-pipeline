import"./chunk-chunk-KNKRZUQM.js";import"./chunk-chunk-E42HLWFU.js";import"./chunk-chunk-2A2SZJUF.js";import"./chunk-chunk-COVP5CLI.js";import"./chunk-chunk-AHRFLY5R.js";import"./chunk-chunk-RJVZMLNZ.js";import{a as e}from"./chunk-chunk-G6O6BLNK.js";var n="pbrFragmentDeclaration",x=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=x);var a="pbrFragmentExtraDeclaration",W=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=W);var o="samplerFragmentAlternateDeclaration",X=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=X);var t="pbrFragmentReflectionDeclaration",Y=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=Y);var r="pbrFragmentSamplersDeclaration",k=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=k);var f="subSurfaceScatteringFunctions",w=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=w);var c="importanceSampling",z=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=z);var l="pbrHelperFunctions",K=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=K);var d="pbrDirectLightingSetupFunctions",q=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=q);var s="pbrDirectLightingFalloffFunctions",Z=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=Z);var E="hdrFilteringFunctions",J=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=J);var R="pbrDirectLightingFunctions",j=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=j);var u="pbrIBLFunctions",Q=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=Q);var C="pbrBlockAlbedoOpacity",$=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=$);var m="pbrBlockReflectivity",ee=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=ee);var S="pbrBlockAmbientOcclusion",ie=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=ie);var A="pbrBlockAlphaFresnel",ne=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=ne);var I="pbrBlockAnisotropic",ae=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=ae);var v="pbrBlockReflection",oe=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=oe);var p="pbrBlockSheen",te=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=te);var N="pbrBlockClearcoat",re=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=re);var T="pbrBlockIridescence",fe=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=fe);var O="pbrBlockSubSurface",ce=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=ce);var L="pbrBlockReflectance0",le=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=le);var g="pbrClusteredLightingFunctions",de=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=de);var h="pbrBlockNormalGeometric",se=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=se);var _="pbrBlockNormalFinal",Ee=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=Ee);var D="pbrBlockLightmapInit",Re=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Re);var M="pbrBlockGeometryInfo",ue=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=ue);var F="pbrBlockReflectance",Ce=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Ce);var P="pbrBlockDirectLighting",me=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=me);var U="pbrBlockFinalLitComponents",Se=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=Se);var b="pbrBlockFinalUnlitComponents",Ae=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=Ae);var B="pbrBlockFinalColorComposition",Ie=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=Ie);var y="pbrBlockImageProcessing",ve=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=ve);var G="pbrBlockPrePass",pe=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=pe);var V="pbrDebug",Ne=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=Ne);var i="pbrPixelShader",H=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=H);var ta={name:i,shader:H};export{ta as pbrPixelShader};
