...
const places = [
  {market:"US-MW-PARKCITY-84098", place:"Park City, Utah 84098", retailer:"Target (Kimball Junction), Walmart (Kimball Junction), Smith's Food & Drug (Park City)", zip:"84098", audience:"Mountain families, Wasatch trail households, resort staff — Aaron", message:"Keep It Wild — protein-packed whole grains for your Wasatch frontier. Nourishment for Today's Frontier", peppers:"—", cheeses:"—", cue:"Farmers Market at Park City Mountain Resort Wed 11-5 — Jensen Farms peaches, Copper Moose rhubarb, Tagges preserves, Bal"},
    {market:"US-UT-KAMASVALLEY", place:"Kamas Valley — Peoa / Oakley, UT 84036 (Wasatch Back rural)", retailer:"Oakley Farmers Market (Rodeo Grounds) + Kamas Valley Market — no commercial retail", zip:"84036", audience:"Peoa ranch families on acreage, Oakley rodeo neighbors, Kamas backyard growers — ranch assembly", message:"Quiet ranch country — no store, no downtown, just river valley and a hot griddle. Kodiak Cakes savory waffle + Oakley grass-fed sausage — Nourishment for Today''s Frontier", peppers:"—", cheeses:"—", cue:"Peoa river valley at dawn, Oakley Rodeo Grounds folding tables of grass-fed meats, Kodiak Cakes on a tailgate with mountain greens, acoustic guitar"},
...
const featuredFrontierDetail = {
  ...
  "US-UT-OAKLEY": {place:"Oakley, Utah 84055 — Wasatch Back ranch country", items:["Splendor Valley Farms produce","Oakley Rodeo Grounds farm stands"], seasons:"Oakley Farmers Market Jun-Sep (2023 season, City of Oakley newsletter); Splendor Valley Farms produce (months unverified)", farmersMarket:"Oakley Farmers Market at Oakley Rodeo Grounds, Jun-Sep (2023 season per City of Oakley newsletter; standalone URL unconfirmed — research dispatch)"},
  ...
  "US-CA-BOLINAS": {place:"Bolinas, California 94924 — Marin farm coast", items:["Marin goat cheese","coastal produce"], seasons:"Marin goat cheese (months unverified); coastal produce May-Oct", farmersMarket:"Bolinas Farmers Market (Saturdays) https://www.marincountyvisitor.com/things-to-do/family-fun/farmers-markets/"},
  ...
  "US-GA-SENOIA": {place:"Senoia, Georgia 30276 — Coweta farm country", items:["Coweta peaches","butterbeans"], seasons:"Peach season May-Aug", farmersMarket:"Senoia Farmers Market https://explorenewnancoweta.com/things-to-do/events/senoia-farmers-market/2025-08-23/"},
