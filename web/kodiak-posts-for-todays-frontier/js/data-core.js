...
const featuredFrontierDetail = {
  ...
  "US-OH-CINCINNATI": {place:"Cincinnati, Ohio 45202 — Findlay Market river city", items:["ramps","morel mushrooms","strawberries","sweet corn","pawpaws","black walnuts"], seasons:"Ramps Mar; morels Apr; strawberries May; corn Jul; pawpaws Sep; black walnuts Dec", farmersMarket:"Findlay Market, year-round", farms:["Ohio River Valley orchards"], coops:["Big Table Farm Co-op (Cincinnati)","Turner Farm (Cincinnati)"]},
  "US-OH-DAYTON": {place:"Dayton, Ohio 45402 — Miami Valley maple corridor", items:["maple syrup","strawberries","sweet corn","tomatoes","apples"], seasons:"Maple Feb; strawberries May; corn Jul; tomatoes Aug; apples Oct", farmersMarket:"2nd Street Market (Saturdays)", farms:["Downing Fruit Farm","Dohner Maple Products","Fulton Farms","Patchwork Gardens","Mile Creek Farm"], coops:["Mission of Mary Cooperative (Dayton)"]},
