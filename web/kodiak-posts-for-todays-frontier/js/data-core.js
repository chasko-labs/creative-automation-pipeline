...
const featuredFrontierDetail = {
  ...
  "US-UT-MIDWAY": {place:"Midway, Utah 84049 — Wasatch County farm town", items:["Swiss-cheese dairy","root vegetables"], seasons:"Summer market season Jun-Sep (exact months unconfirmed — research dispatch)", farmersMarket:"Midway Town Square market stands (standalone URL unconfirmed — research dispatch)"},
  "US-UT-GRANTSVILLE": {place:"Grantsville, Utah 84029 — Tooele County ranch town", items:["grass-fed beef","ranch eggs"], seasons:"Year-round ranch; summer stands Jun-Sep", farmersMarket:"Grantsville farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-UT-KAMASVALLEY": {place:"Kamas Valley, Utah 84036 — Peoa/Oakley ranch country", items:["Oakley grass-fed beef","mountain produce"], seasons:"Summer market season (exact months unconfirmed — research dispatch)", farmersMarket:"Oakley Farmers Market at Oakley Rodeo Grounds (standalone URL unconfirmed — research dispatch)"},
  "US-NM-HATCH": {place:"Hatch, New Mexico 87937 — chile capital of the world", items:["Hatch green chile","chile ristras"], seasons:"Hatch roast Aug-Sep", farmersMarket:"Hatch roadside stands + roasters (standalone URL unconfirmed — research dispatch)"},
  "US-NM-CORRALES": {place:"Corrales, New Mexico 87048 — Rio Grande bosque farms", items:["Corrales corn","valley produce"], seasons:"Summer market season Jun-Sep (exact months unconfirmed — research dispatch)", farmersMarket:"Corrales Growers Market (schedule unconfirmed — research dispatch)"},
  "US-NM-CHIMAYO": {place:"Chimayo, New Mexico 87522 — high-road chile country", items:["Chimayo chile","heirloom corn"], seasons:"Chile harvest Aug-Oct", farmersMarket:"Chimayo farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-SW-CLOUDCROFT": {place:"Cloudcroft, New Mexico 88317 — Sacramento Mountain lodge town", items:["pinon nuts","mountain berries"], seasons:"Summer season Jun-Sep; pinon fall (exact months unconfirmed — research dispatch)", farmersMarket:"Cloudcroft Mercantile halo (no confirmed standalone farmers market — research dispatch)"},
  "US-NM-ARTESIA": {place:"Artesia, New Mexico 88210 — Pecos Valley dairy + pecan country", items:["pecans","dairy"], seasons:"Pecan harvest Oct-Dec", farmersMarket:"Artesia farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-NM-LALUZ": {place:"La Luz, New Mexico 88337 — Sacramento foothill orchards", items:["canyon apples","stone fruit"], seasons:"Orchard season Jul-Sep (exact months unconfirmed — research dispatch)", farmersMarket:"La Luz farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-TX-FABENS": {place:"Fabens, Texas 79838 — lower Rio Grande Valley farms", items:["valley chile","pecans"], seasons:"Chile roast Aug-Sep; pecans Oct-Dec", farmersMarket:"Fabens farm stands (standalone URL unconfirmed — research dispatch)"},
  ...
  "US-CO-ELIZABETH": {place:"Elizabeth, Colorado 80107 — Elbert County ranch country", items:["grass-fed beef","ranch eggs"], seasons:"Year-round ranch; summer stands Jun-Sep", farmersMarket:"Elbert County farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-CO-LYONS": {place:"Lyons, Colorado 80540 — St Vrain farm belt", items:["St Vrain produce","orchard fruit"], seasons:"Summer produce Jun-Sep", farmersMarket:"Lyons farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-WY-ALPINE": {place:"Alpine, Wyoming 83128 — Star Valley dairy country", items:["Star Valley dairy","root vegetables"], seasons:"Summer dairy season Jun-Sep", farmersMarket:"Star Valley farm stands (standalone URL unconfirmed — research dispatch)"},
  ...
  "US-WA-CARNATION": {place:"Carnation, Washington 98014 — Snoqualmie Valley farm town", items:["Remlinger berries","valley corn"], seasons:"Berry season Jun-Aug; corn Aug-Sep", farmersMarket:"Remlinger Farms stand + valley farm stands"},
  "US-OR-SAUVIE": {place:"Sauvie Island, Oregon 97231 — Portland farm island", items:["island berries","pumpkins"], seasons:"Berry season Jun-Aug; pumpkin patch Sep-Oct", farmersMarket:"Sauvie Island farm stands"},
  "US-WA-TIETON": {place:"Tieton, Washington 98947 — Yakima orchard town", items:["Tieton apples","stone fruit"], seasons:"Stone fruit Jul-Aug; apples Sep-Oct", farmersMarket:"Tieton farm stands (standalone URL unconfirmed — research dispatch)"},
  ...
  "US-CA-BOLINAS": {place:"Bolinas, California 94924 — Marin farm coast", items:["Marin goat cheese","coastal produce"], seasons:"Goat cheese Feb-Jun; produce year-round", farmersMarket:"Bolinas + Point Reyes farm stands"},
  "US-CA-BRENTWOOD": {place:"Brentwood, California 94513 — Delta farm town", items:["Delta cherries","sweet corn"], seasons:"Cherry season May-Jun; corn Jul-Aug", farmersMarket:"Brentwood U-pick stands (standalone URL unconfirmed — research dispatch)"},
  "US-CA-FILLMORE": {place:"Fillmore, California 93015 — Santa Clara Valley citrus", items:["Fillmore citrus","avocados"], seasons:"Citrus Nov-Apr; avocado spring", farmersMarket:"Fillmore farm stands (standalone URL unconfirmed — research dispatch)"},
  ...
  "US-GA-SENOIA": {place:"Senoia, Georgia 30276 — Coweta farm country", items:["Coweta peaches","butterbeans"], seasons:"Peach season May-Aug", farmersMarket:"Coweta farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-TN-LEIPERSFORK": {place:"Leipers Fork, Tennessee 37064 — Williamson rural", items:["Williamson produce","sorghum"], seasons:"Summer produce Jun-Sep", farmersMarket:"Leipers Fork farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-KY-SHELBYVILLE": {place:"Shelbyville, Kentucky 40065 — Shelby County ag", items:["KY sweet corn","tomatoes"], seasons:"Corn season Jul-Sep", farmersMarket:"Shelby County farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-MS-HERNANDO": {place:"Hernando, Mississippi 38632 — DeSoto farm town", items:["DeSoto produce","sweet potatoes"], seasons:"Summer produce Jun-Sep; sweets Sep-Nov", farmersMarket:"Hernando farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-AL-CLANTON": {place:"Clanton, Alabama 35045 — Chilton peach county", items:["Chilton peaches","pecans"], seasons:"Peach season May-Aug; pecans Oct-Dec", farmersMarket:"Clanton peach stands (standalone URL unconfirmed — research dispatch)"},
  ...
  "US-IL-HARVARD": {place:"Harvard, Illinois 60033 — McHenry dairy town", items:["McHenry dairy","sweet corn"], seasons:"Corn season Jul-Sep", farmersMarket:"McHenry farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-MN-STILLWATER": {place:"Stillwater, Minnesota 55082 — St Croix orchard town", items:["St Croix apples","pumpkins"], seasons:"Apple season Sep-Oct", farmersMarket:"Stillwater orchard stands (standalone URL unconfirmed — research dispatch)"},
  "US-WI-CEDARBURG": {place:"Cedarburg, Wisconsin 53012 — Ozaukee farm town", items:["Ozaukee strawberries","sweet corn"], seasons:"Strawberry season Jun-Jul", farmersMarket:"Cedarburg farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-MI-ARMADA": {place:"Armada, Michigan 48005 — Macomb orchard town", items:["Armada apples","peaches"], seasons:"Peach season Aug; apples Sep-Oct", farmersMarket:"Armada orchard stands (standalone URL unconfirmed — research dispatch)"},
  "US-OH-BURTON": {place:"Burton, Ohio 44021 — Geauga maple country", items:["Geauga maple","apples"], seasons:"Maple season Mar-Apr; apples Sep-Oct", farmersMarket:"Geauga farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-IN-DANVILLE": {place:"Danville, Indiana 46122 — Hendricks farm town", items:["Hendricks corn","tomatoes"], seasons:"Corn season Jul-Sep", farmersMarket:"Hendricks farm stands (standalone URL unconfirmed — research dispatch)"},
  ...
  "US-MA-BOLTON": {place:"Bolton, Massachusetts 01740 — orchard town", items:["Bolton apples","cider"], seasons:"Apple season Sep-Oct", farmersMarket:"Bolton orchard stands (standalone URL unconfirmed — research dispatch)"},
  "US-NY-WARWICK": {place:"Warwick, New York 10990 — black-dirt farm town", items:["black-dirt onions","sweet corn"], seasons:"Onion harvest Aug-Sep", farmersMarket:"Warwick farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-PA-KENNETT": {place:"Kennett Square, Pennsylvania 19348 — mushroom capital", items:["Kennett mushrooms","produce"], seasons:"Mushrooms year-round", farmersMarket:"Kennett Square farm stands"},
  "US-VA-PURCELLVILLE": {place:"Purcellville, Virginia 20132 — Loudoun farm town", items:["Loudoun produce","orchard fruit"], seasons:"Summer produce Jun-Sep", farmersMarket:"Loudoun farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-MD-WESTMINSTER": {place:"Westminster, Maryland 21157 — Carroll farm town", items:["Carroll corn","dairy"], seasons:"Corn season Jul-Sep", farmersMarket:"Carroll farm stands (standalone URL unconfirmed — research dispatch)"},
  "US-VT-SHELBURNE": {place:"Shelburne, Vermont 05482 — lake farm town", items:["Shelburne cheddar","orchard fruit"], seasons:"Cheddar year-round; apples Sep-Oct", farmersMarket:"Shelburne Farms stand + farm stands"},
  "US-CT-SUFFIELD": {place:"Suffield, Connecticut 06078 — river-valley farm town", items:["valley produce","sweet corn"], seasons:"Corn season Jul-Sep", farmersMarket:"Suffield farm stands (standalone URL unconfirmed — research dispatch)"},
